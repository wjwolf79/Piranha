...
namespace Piranha.IO
{
	...
	/// </summary>
	public sealed class LocalMediaCacheProvider : IMediaCacheProvider
	{
		#region Members
		private readonly string BasePath = HttpContext.Current.Server.MapPath("~/App_Data/Cache") ;

		/// <summary>
		/// The local base path for all media files.
		/// </summary>
		private readonly string MediaPath = HttpContext.Current.Server.MapPath("~/App_Data/Cache/Content") ;

		/// <summary>
		/// The local base path for all media files.
		/// </summary>
		private readonly string UploadPath = HttpContext.Current.Server.MapPath("~/App_Data/Cache/Uploads") ;
		#endregion
		...
		private string GetPath(Guid id, bool draft, int width, int? height, MediaType type = MediaType.Media) {
